...
const run = async () => {
  ...
  await Product.create(
    ...
    },
    {
      ...
      description:
        'Продам Subaru LEGACY\n' +
        'Свежепригнан ,растаможен,не оформлен.\n' +
        'Год выпуска : 2020\n' +
        'Объём : 2,5 куб.\n' +
        'Пробег : 70200 км.\n' +
        'Привод-полный (4 WD)\n' +
        'Камера заднего вида, дистроник,шифтроник,подогрев руля, круиз-контроль, AUX, USB, BT, ксенон,климат контроль.\n' +
        'Авто без вложений.\n' +
        'Для тех кому дорого, проходим мимо.\n' +
        'Небольшой торг у капота.\n' +
        'Цена : 20800$',
      price: 1780000,
      image: 'fixtures/mers.webp',
    },
    ...
    },
    {
      ...
      description:
        'Zara куртка рубашка, водонепроницаемая,\n' +
        '\n' +
        'новая,\n' +
        '\n' +
        'размер: М,\n' +
